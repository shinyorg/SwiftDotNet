...
/// <summary>
/// Reusable iOS application delegate that hosts a SwiftDotNet root view as real SwiftUI. Subclass it,
/// export the ObjC name, and return your root — the window + host-controller wiring is done for you:
/// <code>
